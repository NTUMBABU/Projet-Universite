<header>
  <div class="point-dr">
    <h3>UNIVERSITE DES <span>MASCAREIGNES</span></h3>
  </div>
  <div class="point-gc">
    <div class="projects">
              <label for="bout">
                ...
                <ul>
                  <li><img src="/Projet-Universite/multi-media/profil.png" height="110" width="110" style="border-radius: 50%;border:1px solid grey;margin-left:40px;"></li>
                  <hr>
                  <li class="li1"> <a href="/Projet-Universite/admis/editProfil.php">Profil</a> </li>
                  <li class="li2"> <button type="button" name="button" style="background:#F65032;">Se déconnecter</button> </li>
                </ul>
              </div>
  </div>
</header>
...
<div class="side-bar">
  <a href="/Projet-Universite/admis/administrateur.php"><img src="/Projet-Universite/multi-media/dashboard.png" height="30" width="30"> <span>Tableau de bord</span></a>
